...
# Set directories
input_dir="/workdir/hdd29/chloroplast_genome_evaluation/data/speciesWork/Cucurbita/resequencedMoschataGenomes/"
final_dir="/workdir/hdd29/chloroplast_genome_evaluation/ddata/speciesWork/Cucurbita/resequencedMoschataAnnotations/"
